...
namespace Assets.Scripts.UI
{
    public class SkillView : MonoBehaviour
    {
        ...
        private void Awake()
        {
            _skill.FailedExecute += OnFailedExecute;
            _skill.StartedDuration += OnStartedDuration;
            _skill.TickedDuration += OnTickedDuration;
            _skill.StartedCooldown += OnStartedCooldown;
            _skill.EndedCooldown += OnEndedCooldown;
